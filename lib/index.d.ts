import { StateSchema, EventObject, MachineConfig, MachineOptions, StateMachine } from 'xstate';
...
export declare function routerMachine<TContext = any, TState extends StateSchema = any, TEvent extends EventObject = any>({ config, options, initialContext, history, }: RouterArgs): import("xstate").Interpreter<any, any, any, any>;
export declare function useRouterMachine<TContext = any, TState extends StateSchema = any, TEvent extends EventObject = any>({ config, options, initialContext, history, }: RouterArgs): {
